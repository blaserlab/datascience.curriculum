...
Assuming the commands above have run properly you should be ready to use git and github.  Working in the terminal is the recommended approach.  It is just easier.
