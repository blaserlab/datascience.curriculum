...
Today we discuss fundamentals of working with data in R.  This lecture borrows from [Software Carpentry](http://swcarpentry.github.io/swc-releases/2017.08/r-novice-inflammation/) which you may find to be a useful resource for additional learning.
...
# substitute a file path to your own data
# readr::read_csv(file = system.file("extdata/demo_iris_data.csv", package = "datascience.curriculum"))
read_csv("inst/extdata/demo_iris_data.csv", col_types = "fddddc")
```
...
# readr::read_csv(file = system.file("extdata/demo_iris_data.csv", package = "datascience.curriculum"))
demo_data <- read_csv("inst/extdata/demo_iris_data.csv", col_types = "fddddc")
...
Dataframes and tibbles are essentially lists of vectors with some rules attached.  Ignoring the rules, what are lists and vectors?
...
A list is a more general form of data object.  It can hold any type of valid R object.  This is how you make a list:
...
In R everything is treated as a vector.  A single value is a vector of length 1.  Many functions are optimized to work on the entire vector at once.
